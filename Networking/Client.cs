...
namespace Defectively.Core.Networking
{
    ...
    {
        /// <summary>
        ///     The account associated with this <see cref="Client"/>.
        /// </summary>
        public Account Account { get; set; }

        /// <summary>
        ///     The state of the connection. If the server notices the <see cref="Client"/> disconnect it will set this value to false.
        /// </summary>
